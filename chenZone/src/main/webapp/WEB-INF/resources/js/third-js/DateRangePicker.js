(function() {
  ...
  DateRangePicker = (function() {
    function DateRangePicker($select, startDate, endDate) {
      ...
      this.initBindings();
      this.setInitRange(startDate, endDate);
    }
    ...
    DateRangePicker.prototype.initBindings = function() {
      ...
      $('.drp-calendar-separator-btn').click(function(evt) {
    	  return self.hide();
    	  });
    ...
    DateRangePicker.prototype.setRange = function(startDate , endDate ,daysAgo) {
    ...
    DateRangePicker.prototype.setInitRange = function(startDate , endDate) {
//        var endDate, startDate;
//        if (isNaN(daysAgo)) {
//          return false;
//        }
...
//        startDate.setDate(endDate.getDate() - daysAgo);
  ...
  $.fn.dateRangePicker = function(startDate ,endDate) {
    return new DateRangePicker(this, startDate ,endDate);
  };
}).call(this);
