...
public interface BaseDAO<T, PK extends Serializable> {
     ...
     */
    public void insertBatch(List<T> entityList) throws Exception;
...
//            @Param(value = "maxIndex") int maxIndex, @Param(value = "pd") PageDomain<T> pd) throws Exception;
     ...
     * @throws Exception
     */
//    public List<T> findDataByCondition(@Param(value = "pd") PageDomain<T> pd) throws Exception;
