...
//    public static String requestUrl(String url, HashMap<String, String> data)  
      public static String requestUrl(String url,String data) 
            throws IOException {  
       ...
       // writer.print(httpBuildQuery(data));  
        ...
        try {  
            streamReader = new InputStreamReader(conn.getInputStream(), "gb2312");  
        } catch (IOException e) {  
            /* 
            Boolean ret2 = true; 
            if (ret2) { 
            ...
            */  
            streamReader = new InputStreamReader(conn.getErrorStream(), "gb2312");  
        } finally {  
